...
/**
 * خدمة تصدير أساسية للـ PDF بدون استخدام autoTable
 */
const basicPdfExport = {
  /**
  ...
  exportToPDF(
    ...
    return new Promise((resolve, reject) => {
      try {
        console.log('Exporting data to PDF using basic export:', data.length, 'records');
        ...
        // إنشاء جدول بسيط بدون استخدام autoTable
